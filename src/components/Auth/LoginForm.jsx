  ...
  return (
    <div className="w-[438px]">
      <div className="mb-[40px] flex flex-col gap-[20px]">
        <h2 className="text-[40px] font-medium leading-[1.2] tracking-[-0.02em]">Log In</h2>
       ...
       <div className="flex flex-col gap-1">
          <input 
            ...
            className={`w-full h-[54px] border rounded-[12px] px-[18px] outline-none transition-colors ${
              errors.email ? "border-red-500" : "border-[rgba(18,23,23,0.1)] focus:border-brand-yellow"
            }`}
          />
        ...
        <div className="flex flex-col gap-1">
          <div className="relative">
            <input 
              ...
              className={`w-full h-[54px] border rounded-[12px] px-[18px] outline-none transition-colors ${
                errors.password ? "border-red-500" : "border-[rgba(18,23,23,0.1)] focus:border-brand-yellow"
              }`}
            />
            <button 
              type="button"
